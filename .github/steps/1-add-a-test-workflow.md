...
- _Workflow_: A workflow is a unit of automation from its start to finish, including the definition of what triggers the automation, what environment or other aspects should be taken into account during the automation, and what should happen as a result of the trigger.
...
1. Click _Commit changes..._, and choose to make a new branch named `ci`.
1. Click _Propose changes_.
